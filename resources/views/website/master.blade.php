...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}website/{{asset('/')}}website/assets/images/favicon.svg" />
                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            <a href="{{route('cart.delete', ['id' =>$item->rowId])}}" class="remove" title="Remove this item">
