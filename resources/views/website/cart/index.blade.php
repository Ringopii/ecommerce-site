            ...
            <div class="cart-list-head">
                ...
                @foreach($cart_products as $cart_product)
                    <div class="cart-single-list">
                        <div class="row align-items-center">
                            <div class="col-lg-1 col-md-1 col-12">
                                <a href="{{route('product-details', ['id' => $cart_product->id])}}" target="_blank"><img src="{{asset($cart_product->options->image)}}" alt="#"></a>
                            </div>
                            <div class="col-lg-4 col-md-3 col-12">
                                <h5 class="product-name"><a href="{{route('product-details', ['id' => $cart_product->id])}}">{{$cart_product->name}}</a></h5>
                                <p class="product-des">
                            ...
                            <div class="col-lg-1 col-md-2 col-12">
                                <a class="remove-item" onclick="return confirm('Are you sure to delete this..')" href="{{route('cart.delete', ['id' =>$cart_product->rowId])}}">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>
                                            @php($tax = $sum * 0.15)
                                            Tax Amount (15%) <span> {{number_format($tax)}} </span> <span>&#2547; &nbsp;</span>
                                        </li>
                                        <li>Shipping Charge <span> {{ $shipping = 100  }} </span> <span>&#2547; &nbsp;</span></li>
                                        <li class="last">
                                            Total Payable <span>{{ number_format( ($shipping + $sum +  $tax) ) }}</span> <span>&#2547; &nbsp;</span>
                                        </li>
                                    </ul>
                                    <div class="button">
